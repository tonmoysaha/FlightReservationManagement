...
public class TotpAuthenticationFilter extends GenericFilterBean {
	...
	@Autowired
	public TotpAuthenticationFilter(TFODetailsService totpService) {
		this.tfoService=totpService;
	}
	...
	private boolean codeIsValid(String username, String code) {
		return code != null && tfoService.verifyCode(username, Integer.valueOf(code));
	}
